<template>
    ...
    <jet-authentication-card>
        ...
        <div class="flex flex-row">
            <jet-label>Não possui uma conta?</jet-label>
            <Link :href="route('register')" class="underline text-sm text-red-600 hover:red-gray-900 pl-1">
                Fazer uma nova conta
            </Link>
        </div>

        <form @submit.prevent="submit">
            <div class="mt-4">
                <jet-label for="email" value="Email ou Apelido" />
